%%% @doc GET|PUT|DELETE /datasets/referit/:id handler
-module(queryobjseg_single_referit_handler).
...
trails() ->
  ...
  Path = "/datasets/referit/:id",
  Options = #{path => Path, model => queryobjseg_referit, verbose => true},
