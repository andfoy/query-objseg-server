%%% @doc GET|PUT|DELETE /datasets/gref/:id handler
-module(queryobjseg_single_gref_handler).
...
trails() ->
  ...
  Path = "/datasets/gref/:id",
  Options = #{path => Path, model => queryobjseg_gref, verbose => true},
